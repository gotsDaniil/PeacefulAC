...
public class MLAura extends PacketListenerAbstract {
    ...
    private final ConcurrentMap<UUID, Long> lastRotationTime = new ConcurrentHashMap<>();
    private final ConcurrentMap<UUID, Double> lastYaw = new ConcurrentHashMap<>();
    private final ConcurrentMap<UUID, Double> lastPitch = new ConcurrentHashMap<>();

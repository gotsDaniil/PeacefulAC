...
public class PeacefulAntiCheat extends JavaPlugin implements Listener {
    ...
    public void onEnable() {
        ...
        Objects.requireNonNull(this.getCommand("peaceful")).setExecutor(this);
        Objects.requireNonNull(this.getCommand("peacefulac")).setExecutor(this);
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if (command.getName().equalsIgnoreCase("peaceful") || command.getName().equalsIgnoreCase("peacefulac")) {
            if (args.length > 0 && args[0].equalsIgnoreCase("reload")) {
                if (!sender.hasPermission("peaceful.reload")) {
